        ...
        while True:
            ...
            try:
                ...
                if count<=5:
                    ...
                    print("No "+goal+" detected in FoV of Misty")
                    count = 0 
                    heading = calculate_absolute_heading(self.get_current_yaw(), +100)
                ...
                if count !=6:
                    heading = calculate_absolute_heading(self.get_current_yaw(), angle)
                    self.misty.drive_arc(heading = heading, radius=.01, timeMs=1000, reverse = False)
                else:
                    heading = calculate_absolute_heading(self.get_current_yaw(), -100)
                    self.misty.drive_arc(heading = heading, radius=.01, timeMs=1000, reverse = False)
